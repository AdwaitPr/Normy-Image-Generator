...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.windowlabel = ctk.CTkLabel(self,text="Adwait's Image Generator", font=ctk.CTkFont(size=30, weight="bold"),padx=50, pady=50,text_color="white")
    ...
    def generate(self):
        ...
        if torch.backends.mps.is_available():
            self.device = torch.device("mps")  # For M1/M2 Macs
        else:
